...
const pieOptions = {
  ...
  return (
    <div className={`w-full min-h-screen p-8 pt-24 transition-colors duration-300   dark:bg-black dark:text-white`}>
      <div className="w-full mb-10 dark:bg-black">
...
{/* Section 2: User Statistics */}
  <section className="w-full mb-10 dark:bg-black dark:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className={`rounded-lg shadow p-6 flex flex-col items-center ${isDark ? "bg-black text-white border border-[#25be85]" : "bg-white text-black border border-[#25be85]"}`}>
